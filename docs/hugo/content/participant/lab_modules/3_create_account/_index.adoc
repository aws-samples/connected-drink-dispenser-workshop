...
. You have downloaded the certificate file (e.g., `34ea05fe7b-certificate.pem.crt`), private key (e.g., `34ea05fe7b-private.pem.key`). This validates that all resources have been created in the cloud based on your username and assigned dispenser Id.
